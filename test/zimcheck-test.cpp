...
TEST(zimcheck, bad_checksum)
{
    const std::string expected_output(
      ...
      "[ERROR] Checksum: ZIM Archive Checksum in archive: 00000000000000000000000000000000" "\n"
      "\n"
...
TEST(zimcheck, metadata_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[WARNING] Integrity check is skipped. Any detected errors may in fact be due to corrupted/invalid data.\n"
      "[INFO] Checking metadata..." "\n"
      "[ERROR] Metadata: Missing mandatory metadata: Title" "\n"
      "[ERROR] Metadata: Missing mandatory metadata: Description" "\n"
      "[ERROR] Metadata: Missing mandatory metadata: Illustration_48x48@1" "\n"
      "[ERROR] Metadata: Language must contain at least 3 characters" "\n"
      "[ERROR] Metadata: Language doesn't match regex: ^\\w{3}(,\\w{3})*$" "\n"
      "[INFO] Overall Test Status: Fail" "\n"
      "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
    );
...
TEST(zimcheck, favicon_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[WARNING] Integrity check is skipped. Any detected errors may in fact be due to corrupted/invalid data.\n"
      "[INFO] Searching for Favicon..." "\n"
      "[ERROR] Favicon: Favicon is missing" "\n"
      "[INFO] Overall Test Status: Fail" "\n"
      "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
    );
...
TEST(zimcheck, mainpage_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[WARNING] Integrity check is skipped. Any detected errors may in fact be due to corrupted/invalid data.\n"
      "[INFO] Searching for main page..." "\n"
      "[ERROR] Main Page: Main Page Index stored in Archive Header: 4294967295" "\n"
      "[INFO] Overall Test Status: Fail" "\n"
      "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
    );
...
TEST(zimcheck, empty_items_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[WARNING] Integrity check is skipped. Any detected errors may in fact be due to corrupted/invalid data.\n"
      "[INFO] Verifying Articles' content..." "\n"
      "[ERROR] Empty Article: Entry empty.html is empty" "\n"
      "[INFO] Overall Test Status: Fail" "\n"
      "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
    );
...
TEST(zimcheck, internal_url_check_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "\n"
      "[ERROR] Internal URL: Dangling link(s) in article 'dangling_link.html':" "\n"
      "  - 'A/removed.html' (resolves to 'A/removed.html')" "\n"
      "\n"
...
TEST(zimcheck, external_url_check_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[ERROR] External URL: http://example.com/ is an external dependence in article multi_external_src.html" "\n"
      "[INFO] Overall Test Status: Fail" "\n"
      "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
    );
...
TEST(zimcheck, redundant_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[INFO] Searching for redundant articles..." "\n"
      "  Verifying Similar Articles for redundancies..." "\n"
      "[WARNING] Redundant Data: article1.html and redundant_article.html" "\n"
      "[INFO] Overall Test Status: Pass" "\n"
      "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
    );
...
TEST(zimcheck, redirect_loop_poorzimfile)
{
  const std::string expected_output(
    ...
    "[WARNING] Integrity check is skipped. Any detected errors may in fact be due to corrupted/invalid data.\n"
    "[INFO] Checking for redirect loops..." "\n"
    "[ERROR] Redirect Loop: Redirect loop exists from entry redirect_loop.html" "\n"
    "\n"
    "[ERROR] Redirect Loop: Redirect loop exists from entry redirect_loop2.html" "\n"
    "\n"
    "[ERROR] Redirect Loop: Redirect loop exists from entry redirect_loop3.html" "\n"
    "\n"
    "[INFO] Overall Test Status: Fail" "\n"
    "[INFO] Total time taken by zimcheck: <3 seconds." "\n"
  );
...
TEST(zimcheck, json_poorzimfile)
{
    ...
    ASSERT_EQ(
      ...
      "        \"A/removed.html\""                                       "\n"
      "      ],"                                                            "\n"
      "      \"normalized_link\" : \"A/removed.html\","                  "\n"
      "      \"path\" : \"dangling_link.html\""                             "\n"
      "    },"                                                              "\n"
      "    {"                                                               "\n"
      "      \"check\" : \"empty\","                                        "\n"
      ...
      "      \"check\" : \"url_external\","                                 "\n"
      "      \"level\" : \"ERROR\","                                        "\n"
      "      \"message\" : \"http://a.io/img.png is an external dependence in article multi_external_src.html\"," "\n"
      "      \"link\" : \"http://a.io/img.png\","                           "\n"
      "      \"path\" : \"multi_external_src.html\""                        "\n"
      "    },"                                                              "\n"
      "    {"                                                               "\n"
      "      \"check\" : \"url_external\","                                 "\n"
      "      \"level\" : \"ERROR\","                                        "\n"
      "      \"message\" : \"http://example.com/ is an external dependence in article multi_external_src.html\"," "\n"
